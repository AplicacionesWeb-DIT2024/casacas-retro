...
class FillPermissionsForCamiseta extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCamiseta constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.camiseta',
            'admin.camiseta.index',
            'admin.camiseta.create',
            'admin.camiseta.show',
            'admin.camiseta.edit',
            'admin.camiseta.delete',
            'admin.camiseta.bulk-delete',
        ]);
